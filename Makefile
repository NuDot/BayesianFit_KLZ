...
# on the next line
CXXSRCS = BLFitModel.cxx ParameterFactory.cxx Parameter.cxx DataFactory.cxx EnergyResponse.cxx PlotFactory.cxx

# List of all program sources used in the program,
# separated by spaces. A backslash indicates continuation
# on the next line
PRGSRCS = runBLFit.cxx plot.cxx plot_parameter.cxx

# compiler and flags
CXX       = g++
CXXFLAGS  = -g -O2 -Wall -fPIC -Wno-deprecated -w -rdynamic
